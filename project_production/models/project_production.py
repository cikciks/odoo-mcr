...
class ProjectTask(models.Model):
    ...
    weight_pack = fields.Char(required=False, string="Weight per Pack (kg)")
    weight_box = fields.Char(required=False, string="Weight per Box (kg)")
    qty_in_box = fields.Char(required=False, string="Quantity in Box")
    qty_in_pack = fields.Char(required=False, string="Quantity in Pack")
