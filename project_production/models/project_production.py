...
class ProjectTask(models.Model):
    ...
    date_sample1 = fields.Date(required=True, string="Ship to MR")
    date_sample2 = fields.Date(required=True, string="Taken by Courier")
    date_sample3 = fields.Date(required=True, string="Received by Lab")
